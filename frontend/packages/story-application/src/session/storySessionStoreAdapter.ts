...
export function createStorySessionStoreState(
  ...
  return {
    ...
    loadStory: (storyId: string, options?: { resume?: boolean }) =>
      controller.loadStory(storyId, options),
    ...
    regenerateStoryDanbot: () => controller.regenerateStoryDanbot(),
    regenerateStoryImages: () => controller.regenerateStoryImages(),
